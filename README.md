# <p align="center">Intelliflow VChat</p>
...
> **Note**
> To run `Intelliflow VChat` on a `Windows operating system`, you can follow the instructions provided in [this documentation](https://github.com/miroslavpejic85/mirotalksfu/issues/99#issuecomment-1586073853).
...
To `Self-Host Intelliflow VChat` on `Your` dedicated `Server`, read [this documentation](docs/self-hosting.md).
...
If you need help to deploy `Intelliflow VChat` instance on `your dedicated cloud server`, or for other needs, don't hesitate to contact us at sfu.mirotalk@gmail.com
