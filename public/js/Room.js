...
/**
 * Intelliflow VChat - Room component
 *
...
function initClient() {
    ...
    if (!DetectRTC.isMobileDevice) {
        setTippy('shareButton', 'Share', 'right');
        setTippy('hideMeButton', 'Hide self view', 'right');
        ...
        setTippy('chatButton', 'Chat', 'right');
        setTippy('participantsButton', 'Participants', 'right');
        setTippy('whiteboardButton', 'Whiteboard', 'right');
        setTippy('settingsButton', 'Settings', 'right');
        // setTippy('aboutButton', 'About this project', 'right');
        setTippy('exitButton', 'Exit Call', 'right');
...
async function shareRoom(useNavigator = false) {
    ...
    function share() {
        ...
        Swal.fire({
            ...
            <p style="background:transparent; color:white; font-family: Arial, Helvetica, sans-serif;">No need for apps, simply capture the QR code with your mobile camera Or Invite someone else to join by sending them the Link</p>`,
            // showDenyButton: true,
