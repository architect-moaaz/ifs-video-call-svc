# Intelliflow VChat - Self Hosting
...
```bash
# Intelliflow VChat - HTTPS — proxy all requests to the Node app
server {
	# Enable HTTP/2
...
Check Your Intelliflow VChat instance: https://your.domain.name/

---

## Update script

In order to have always Your Intelliflow VChat updated to latest, we going to create a script
...
Follow the commits of the Intelliflow VChat project [here](https://github.com/miroslavpejic85/mirotalksfu/commits/main)

To update your instance of Intelliflow VChat at latest commit, execute:
